...
const NavbarComponent = () => {
  ...
  const [activeCategory, setActiveCategory] = useState(null); // State để lưu mục được chọn
  ...
  const handleCategoryClick = (category) => {
    ...
    setActiveCategory(category); // Cập nhật state với category được click
    navigate(`/${category.toLowerCase()}`, { state: { allTags: categories } });
  };
  ...
  return (
    ...
    //         className="full-screen-navbar"
    //       >
    //         <Nav className="me-auto">
    //           <Nav.Link as={Link} to="/" className="custom-hover">
    //             Home
    //           </Nav.Link>
    //           <NavDropdown
    //             title="Blog"
    ...
    //                 key={category}
    //                 as="button"
    //                 className="custom-hover navbar-color"
    ...
    //             ))}
    //           </NavDropdown>
    //           <Nav.Link as={Link} to="/about" className="custom-hover w-100">
    //             About Me
    //           </Nav.Link>
    //         </Nav>

    //         <div className="d-lg-flex d-block align-items-center ms-auto text-center w-100">
    //           {access_token ? (
    //             <>
    //               <Nav.Link
    //                 as={NavLink}
